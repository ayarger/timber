...
namespace YarnSpinnerGodot
{
    ...
    public interface DialogueViewBase
    {
        ...
        /// </para>
        /// </remarks>
        Action requestInterrupt { get; set; }
        ...
        void RunLine(LocalizedLine dialogueLine, Action onDialogueLineFinished);
        ...
        /// <seealso cref="DismissLine(Action)"/>
        void InterruptLine(LocalizedLine dialogueLine, Action onDialogueLineFinished);
        ...
        void DismissLine(Action onDismissalComplete);
        ...
        void RunOptions(DialogueOption[] dialogueOptions, Action<int> onOptionSelected);
        ...
        /// nothing.</para>
        /// </remarks>
        void UserRequestedViewAdvancement();
        
    }

    public static class DialogueViewBaseExtensions
    {
        public static void DialogueStartedDefault(this DialogueViewBase dialogueViewBase)
        {
            dialogueViewBase.DialogueStarted();
        }

        public static void RunLineDefault(this DialogueViewBase dialogueViewBase, LocalizedLine dialogueLine, Action onDialogueLineFinished)
        {
            // The default implementation does nothing, and immediately calls
            // onDialogueLineFinished.
            onDialogueLineFinished?.Invoke();
            dialogueViewBase.RunLine(dialogueLine, onDialogueLineFinished);
        }

        public static void InterruptLineDefault(this DialogueViewBase dialogueViewBase, LocalizedLine dialogueLine, Action onDialogueLineFinished)
        {
            onDialogueLineFinished?.Invoke();
            dialogueViewBase.InterruptLine(dialogueLine, onDialogueLineFinished);
        }

        public static void DismissLineDefault(this DialogueViewBase dialogueViewBase, Action onDismissalComplete)
        {
            onDismissalComplete?.Invoke();
            dialogueViewBase.DismissLine(onDismissalComplete);
        }

        public static void RunOptionsDefault(this DialogueViewBase dialogueViewBase, DialogueOption[] dialogueOptions, Action<int> onOptionSelected)
        {
            dialogueViewBase.RunOptions(dialogueOptions, onOptionSelected);
        }

        public static void DialogueCompleteDefault(this DialogueViewBase dialogueViewBase)
        {
            dialogueViewBase.DialogueComplete();
        }

        public static void UserRequestedViewAdvancementDefault(this DialogueViewBase dialogueViewBase)
        {
