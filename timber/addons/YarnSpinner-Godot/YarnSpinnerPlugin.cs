...
namespace YarnSpinnerGodot
{
	...
	public partial class YarnSpinnerPlugin : EditorPlugin
	{
		...
		public override void _EnterTree()
		{
			...
			// load icons
			var miniLocalizationIcon = ResourceLoader.Load<Texture>("res://addons/YarnSpinner-Godot/Editor/Icons/Asset Icons/mini_Localization Icon.png");
			var miniYarnSpinnerIcon = ResourceLoader.Load<Texture>("res://addons/YarnSpinner-Godot/Editor/Icons/mini_YarnSpinnerLogo.png");
			var miniYarnProjectIcon = ResourceLoader.Load<Texture>("res://addons/YarnSpinner-Godot/Editor/Icons/Asset Icons/mini_YarnProject Icon.png");
			...
			AddToolMenuItem("YarnSpinner", this, nameof(OnPopupIDPressed));
